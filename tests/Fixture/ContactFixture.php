...
class ContactFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'phone_prefix' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'phone_prefix' => 'Lorem ipsum dolor sit amet',
